...
SELECT
    ...
    -- Classificação em texto limpo
    CASE
        WHEN d.pct_desconto > pc.p90 THEN 'Pricing Opportunity'
        WHEN d.pct_desconto > pc.p75 THEN 'Atencao'
        ELSE 'Saudavel'
    END AS classificacao,

    -- Ordem para o Power BI classificar corretamente (1=crítico, 3=ok)
    CASE
        WHEN d.pct_desconto > pc.p90 THEN 1
        WHEN d.pct_desconto > pc.p75 THEN 2
        ELSE 3
